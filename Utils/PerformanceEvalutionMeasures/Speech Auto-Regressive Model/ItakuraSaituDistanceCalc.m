function [IS_dist] = ItakuraSaituDistanceCalc(reference_signal, distorted_signal, p)
% This function computes the Itakura-Saito distance between two signal vectors.

% The Itakura-Saito distance is a measure of
...
difference_error = (alpha_vec_est - beta_vec_est) * R_0_to_p_a * (alpha_vec_est - beta_vec_est).';

IS_dist = difference_error/alpha_error;
