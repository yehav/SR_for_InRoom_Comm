function [spl, f, params] = iso226_2003_spl_from_loudness_lvl(phon,fq,sq)
...
%       phons = 20;%20:10:80;
%       [spl,f] = iso226_2003_spl_from_loudness_lvl(phons,freqs,true);
% 
%       % plot
...
% Cite As
% Christopher Hummersone (2021). ISO 226:2003 Normal equal-loudness-level
% contours (https://github.com/IoSR-Surrey/MatlabToolbox), GitHub.
